...
class FormMarche extends StatefulWidget {
  const FormMarche(List<Marche>? selectedMarches) : super();

  @override
  _FormMarcheState createState() => _FormMarcheState();
}

class _FormMarcheState extends State<FormMarche> {
  String? dateTime;
...
/*    Services.addPatient(
  ...
  Future add() async {
    final response = await http.post(Uri.http(ipAddress, "/marches/newmarche"),
        headers: {
    ...
    if (200 == response.statusCode) {
      AwesomeDialog(
        ...
        showCloseIcon: true,
        title: 'Succès',
        desc: 'Le Marché a été ajouté avec succès ...',
        btnOkOnPress: () {
  ...
  List<Step> _stepper() {
    List<Step> _steps = [
      ...
      Step(
        subtitle: Text(
          "Clicker Sur Ce Button Pour Ajouter Ce Projet",
  ...
  void initState() {
    ...
    getAllMaitre();
    getAllLots();
    _numMarcheController = TextEditingController();
    _dateMarcheController = TextEditingController();
    _montantMarcheController = TextEditingController();
    _tauxRetenuGarantieController = TextEditingController();
    _dejaPayeController = TextEditingController();
    _dateDebutTravauxController = TextEditingController();
    _dateFinTravauxController = TextEditingController();
    _surfacePlancherController = TextEditingController();
    _avancementController = TextEditingController();
    _avancementAttacheController = TextEditingController();
    _seuilRetenueMarcheController = TextEditingController();
    _seuilPenaliteMarcheController = TextEditingController();
